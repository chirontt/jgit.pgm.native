...
[this](https://repo1.maven.org/maven2/org/eclipse/jgit/org.eclipse.jgit.pgm/6.1.0.202203080745-r/org.eclipse.jgit.pgm-6.1.0.202203080745-r.sh)
of the 6.1.0 version. This shell archive is then normally renamed to `jgit` locally for ease of typing.

On Linux, the shell archive can be run directly.
On Windows, the shell archive can be run with the `java` command, like:
`java -jar org.eclipse.jgit.pgm-6.1.0.202203080745-r.sh --version`
...
Gradle and Maven build scripts are provided for building the project. The JGit version used here is 6.1.0.
